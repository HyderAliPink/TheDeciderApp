      ...
      <div className='overflow-hidden'>
        ...
        >
          {repeatedOptions.map((item, index) => (
            <div
              key={`${item.id}-${index}`}
              className='flex-none rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800 via-slate-900 to-black p-5 text-center shadow-xl'
              style={{ width: `${cardWidth}px`, minWidth: `${cardWidth}px`, height: '200px' }}
            >
              <span className='block break-words text-lg font-semibold leading-tight text-white'>
